...
I18N = {
    "zh": {
        ...
        "version": "版本号：{version}",
        "route_info": "Driver / Contractor 将从 Route Name 自动解析；Hub 将按数据库 receive province 映射",
    ...
    "en": {
        ...
        "route_info": "Driver / Contractor are auto-parsed from Route Name; Hub is mapped from database receive_province",
